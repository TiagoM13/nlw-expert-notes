...
export default function NewNoteCard({ onNoteCreated }: Props) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 outline-none text-left p-5 gap-3 hover:ring-2 hover:ring-slate-400 focus-visible:ring-2 focus-visible:ring-lime-600">
